...
.button.is-primary:focus:not(:active), .button.is-primary.is-focused:not(:active) {
  box-shadow: 0 0 0 0.125em rgba(255, 128, 128, 0.25);
}
...
.button.is-primary.is-outlined.is-loading::after {
  border-color: transparent transparent #ff8080 #ff8080 !important;
}
...
.progress.is-primary:indeterminate {
  background-image: linear-gradient(to right, #ff8080 30%, hsl(0, 0%, 93%) 30%);
}
...
.file.is-primary:focus .file-cta, .file.is-primary.is-focused .file-cta {
  border-color: transparent;
  box-shadow: 0 0 0.5em rgba(255, 128, 128, 0.25);
  color: #fff;
}
...
.hero.is-primary.is-bold {
  background-image: linear-gradient(141deg, #ff4d6b 0%, #ff8080 71%, #ffaa9a 100%);
}
@media screen and (max-width: 768px) {
