...
.content blockquote .numberCircle.invert {
  color: rgb(103, 75, 218);
 ...
 */
a.button.is-ghost.is-medium {
  color: rgb(74, 55, 194);
  text-decoration: none;
  font-weight: 600;
  letter-spacing: 0.05rem;
}
a.button.is-ghost.is-medium:hover, a.button.is-ghost.is-medium:active, a.button.is-ghost.is-medium:focus, a.button.is-ghost.is-medium:focus-within {
  color: rgb(34, 34, 34);
