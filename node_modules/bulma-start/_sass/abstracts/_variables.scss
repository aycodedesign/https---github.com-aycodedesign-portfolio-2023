...
/// Regular font family
/// @type List
$text-font-stack: "Kanit", "Open Sans", "Helvetica Neue Light", "Helvetica Neue",
...
/// Copy text color
/// @type Color
$text-color: rgb(38, 47, 51) !default;

/// Main brand color
/// @type Color
// $brand-color: rgb(229, 0, 80) !default;
$brand-color: rgb(215, 215, 215) !default;

/// Light grey
/// @type Color
$text-invert: rgb(225, 225, 225) !default;
...
// Navbar
$navbar-item-hover-background-color: hsla(0, 0%, 0%, 0);
